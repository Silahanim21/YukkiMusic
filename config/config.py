...
EXTRA_PLUGINS_REPO = getenv(
    "EXTRA_PLUGINS_REPO",
    "https://github.com/Silahanim21/extra-plugins",
)
...
START_IMG_URL = getenv(
    "START_IMG_URL",
    "https://envs.sh/Lx9.jpg",  # This is the file id of the photo you can also put the url of photo
)

PING_IMG_URL = getenv(
    "PING_IMG_URL",
    "https://envs.sh/Lx9.jpg",
)
