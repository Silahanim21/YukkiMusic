...
EXTRA_PLUGINS_REPO = getenv(
    "EXTRA_PLUGINS_REPO",
    "https://github.com/Silahanim21/Extra-Plugin/tree/master/plugins",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/kumsaldestekkanal"
)  # Example:- https://t.me/kumsaldestekkanal
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP",
"https://t.me/kumsalmuzikk"
)  # Example:- https://t.me/kumsalmuzikk
...
START_IMG_URL = getenv(
    "START_IMG_URL",
    "https://envs.sh/LxM.jpg",  # This is the file id of the photo you can also put the url of photo
)

PING_IMG_URL = getenv(
    "PING_IMG_URL",
    "https://envs.sh/LxM.jpg",
)
